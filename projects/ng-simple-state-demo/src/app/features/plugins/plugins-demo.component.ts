...
@Component({
  ...
  template: `
    ...
    <div class="demo-section">
      <h4>Items List</h4>
      <p>
        <strong>Count:</strong> {{ itemCount() }} | <strong>Last Action:</strong> {{ lastAction() }}
      </p>
...
export class PluginsDemoComponent {
  ...
  private readonly undoRedo =
    inject<NgSimpleStateUndoRedoPlugin<PluginsState>>(NG_SIMPLE_STATE_UNDO_REDO);
