...
describe('Storage Integration Tests', () => {
  describe('Local Storage', () => {
    ...
    it('should persist state to localStorage on change', () => {
      TestBed.configureTestingModule({
        providers: [provideNgSimpleState({ enableDevTool: false }), LocalStoragePreferencesStore],
      });
  ...
  describe('Session Storage', () => {
    ...
    it('should persist state to sessionStorage', () => {
      TestBed.configureTestingModule({
        providers: [provideNgSimpleState({ enableDevTool: false }), SessionStoragePreferencesStore],
      });
  ...
  describe('Custom Storage', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        providers: [provideNgSimpleState({ enableDevTool: false }), CustomStoragePreferencesStore],
      });
...
describe('Deep Comparator Integration Tests', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideNgSimpleState({ enableDevTool: false }), DeepComparisonStore],
    });
...
describe('Array State Integration Tests', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideNgSimpleState({ enableDevTool: false }), ArrayStore],
    });
