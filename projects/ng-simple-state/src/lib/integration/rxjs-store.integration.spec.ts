...
class ChatStore extends NgSimpleStateBaseRxjsStore<ChatState> {
  ...
  selectActiveRoom(): Observable<ChatRoom | undefined> {
    return this.selectState((state) => state.rooms.find((r) => r.id === state.activeRoomId));
  }
...
describe('RxJS Chat Application Integration Tests', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideNgSimpleState({ enableDevTool: false }), ChatStore],
    });
...
describe('RxJS Kanban Board Integration Tests', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideNgSimpleState({ enableDevTool: false }), KanbanStore],
    });
...
describe('RxJS Store with Undo/Redo Plugin', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [provideNgSimpleState({ enableDevTool: false, plugins: [plugin] }), ChatStore],
    });
    chatStore = TestBed.inject(ChatStore);
  });
